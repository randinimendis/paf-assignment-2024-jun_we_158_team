...
export const followingPostSlice = createSlice({
  ...
  reducers: {
      ...
      deletePost: (state, action) => {
        if (state.followingPosts !== null) {
          state.followingPosts = state.followingPosts.filter(post => post.post.id !== action.payload);
        }
      },
  },
...
export const { addLove, addShare, addComment, deletePost } = followingPostSlice.actions;
