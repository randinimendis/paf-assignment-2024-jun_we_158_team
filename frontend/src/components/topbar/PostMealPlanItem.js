...
import postStyles from "./styles/PostMealPlanItem.module.css"; // Adjusted import path
import { useDispatch } from "react-redux";
import { addLove, addShare, addComment, getFollowingPosts } from "../feature/followingPost/followingPostSlice";

function PostMealPlanItem(props) {
  ...
  const [currentUserId, setCurrentUserId] = useState(localStorage.getItem("psnUserId"));
    ...
    <div className="border shadow rounded-3 border-primary p-3 mt-3">
      <Row>
        ...
        <div className="d-flex justify-content-center align-items-center">
          ...
          <div className="mx-3">
            <span
              className={`${postStyles.loveButton} mx-1 fs-4`}
          ...
          <div className="mx-3">
            <span
              className={`${postStyles.commentButton} mx-1 fs-4`}
          ...
          <div className="mx-3">
            <span
              className={`${postStyles.shareButton} mx-1 fs-4`}
...
export default PostMealPlanItem;
